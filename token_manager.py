...
def is_token_expiring_soon(creds: Credentials, buffer_days: int = DEFAULT_REFRESH_BUFFER_DAYS) -> bool:
...
def check_and_refresh_token(creds: Optional[Credentials] = None, 
                           buffer_days: int = DEFAULT_REFRESH_BUFFER_DAYS) -> Tuple[Optional[Credentials], bool]:
