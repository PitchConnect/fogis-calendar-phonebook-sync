...
def test_send_notification(mock_config):
    ...
    with mock.patch.object(notification, "send_email_notification", return_value=True) as mock_email:
    ...
    with mock.patch.object(notification, "send_discord_notification", return_value=True) as mock_discord:
        result = notification.send_notification(auth_url, mock_config)
    ...
    with mock.patch.object(notification, "send_slack_notification", return_value=True) as mock_slack:
        result = notification.send_notification(auth_url, mock_config)
