...
from redis_integration.redis_service import (  # noqa: E402
...
class TestCalendarServiceRedisService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.service = CalendarServiceRedisService(redis_url="redis://test:6379", enabled=True)
    ...
    def test_handle_calendar_sync_start_success(self):
        ...
        sync_details = {"sync_cycle": 1, "start_time": datetime.now().isoformat()}
    ...
    def test_handle_calendar_sync_complete_success(self):
        ...
        result = self.service.handle_calendar_sync_complete(sync_results, sync_details)
